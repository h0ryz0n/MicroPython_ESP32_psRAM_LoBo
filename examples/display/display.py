...
# Adafruit:
tft.init(tft.ST7789, width=240, invrot=3, rot=1, bgr=False, height=240, miso=2, mosi=19,
         clk=18, cs=5, dc=27, speed=40000000, color_bits=tft.COLOR_BITS16, backl_pin=12, backl_on=1)


i2c0 = machine.I2C(0, scl=22, sda=21)
pmu = axp202.PMU(i2c0)
...
i2c1 = machine.I2C(1, scl=32, sda=23, speed=400000)
ts.init(i2c1)
